...
plot(contDTime, df1[,5], type="l", xlab="datetime", ylab="Voltage")
...
legend("topright",c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"),lty=1, bty="n", col=c("black", "red", "blue"), cex=0.9, y.intersp=0.8)
plot(contDTime, df1[,4], type="l", xlab="datetime", ylab="Global_reactive_power")
